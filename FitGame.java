...
public class FitGame{
  ...
  private Map<Character,GeneticAgent> players;
   ...
   * */
  private void init(){
    players = new HashMap<Character,GeneticAgent>();
   ...
   * */
  public void addPlayer(GeneticAgent a){
   ...
   **/
	public static Map<Integer,Integer> playFitGame(ArrayList<Genome> gens)
	{
		...
		{
			f.stopwatchOn();
			f.addPlayer(new GeneticAgent(gens.get(i)));
